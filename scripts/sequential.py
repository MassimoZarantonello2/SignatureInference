from SequentialEvaluationsRunner import SequentialEvaluationsRunner
import argparse
...
if __name__ == "__main__":
    ...
    er = SequentialEvaluationsRunner(          # The labels are the names of the columns of the binarized ground truth df
